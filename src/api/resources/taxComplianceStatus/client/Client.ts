...
export class TaxComplianceStatus {
    ...
    public async listTaxComplianceStatus(
        request: Belvo.ListTaxComplianceStatusRequest = {}
    ): Promise<Belvo.TaxComplianceStatusPaginatedResponse> {
        const {
            page,
            pageSize,
            omit,
    ...
    public async retrieveTaxComplianceStatus(
        request: Belvo.RetrieveTaxComplianceStatusRequest
    ): Promise<Belvo.TaxComplianceStatus> {
    ...
    public async detailTaxComplianceStatus(
        id: string,
        request: Belvo.DetailTaxComplianceStatusRequest = {}
    ): Promise<Belvo.TaxComplianceStatus> {
