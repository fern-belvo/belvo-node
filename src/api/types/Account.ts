...
export interface Account {
    ...
    createdAt?: string;
    category?: BelvoApi.EnumAccountCategory;
    /**
    ...
    number?: string;
    balance: BelvoApi.AccountsBalance;
    /**
    ...
    creditData: BelvoApi.AccountsCreditData;
    loanData: BelvoApi.AccountsLoanData;
    /** One or more funds that contribute to the the pension account. */
    fundsData?: BelvoApi.AccountsFundsData[];
    receivablesData?: BelvoApi.AccountsReceivablesData;
    /**
