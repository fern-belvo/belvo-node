...
export interface Charge {
    ...
    paymentMethodType?: Belvo.EnumPaymentLinkAllowedPaymentMethod;
    paymentMethodDetails: Belvo.ChargePaymentMethodDetails;
    ...
    transactions?: Belvo.PaymentTransaction[];
    /**
