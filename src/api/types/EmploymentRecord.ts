...
export interface EmploymentRecord {
    ...
    personalData?: Belvo.EmploymentRecordPersonalData;
    socialSecuritySummary?: Belvo.EmploymentRecordSocialSecuritySummary;
    /** Details regarding the individual's employment history. */
    employmentRecords?: Belvo.EmploymentRecordDetail[];
    /** Additional PDF binary files relating to the individual's employment. */
    files?: Belvo.EmploymentRecordFile[];
}
