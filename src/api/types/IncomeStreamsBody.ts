...
export interface IncomeStreamsBody {
    ...
    accountId: string;
    incomeType: BelvoApi.EnumIncomeStreamType;
    frequency: BelvoApi.EnumIncomeStreamFrequency;
    /**
