...
export interface InvoiceDian {
    ...
    invoiceType: BelvoApi.EnumInvoiceDianInvoiceType;
    type?: BelvoApi.EnumInvoiceType;
    /** The fiscal ID of the invoice sender. */
    senderId?: string;
    /** The name of the invoice sender. */
    senderName?: string;
    senderDetails?: BelvoApi.InvoiceSenderDetailsDian;
    /**
    ...
    receiverName?: string;
    receiverDetails?: BelvoApi.InvoicesReceiverDetailsDian;
    /** **Note**: This field is not applicable for DIAN Colombia and will return `null`. */
    ...
    paymentMethod?: BelvoApi.EnumInvoiceDianPaymentMethod | undefined;
    /**
     * The description of the payment method used for this invoice.
     *
     */
     ...
     *
     */
    invoiceDetails: BelvoApi.InvoiceDetailDian[];
    /**
     ...
     *
     */
    payments: BelvoApi.InvoicesPaymentsDian[];
    payroll: BelvoApi.InvoicesPayrollDian;
    /**
     * **Note**: This field is not applicable for DIAN Colombia and will return `null`.
     *
     */
     ...
     */
    xml?: string;
    warnings?: BelvoApi.InvoiceWarningsDian;
}
