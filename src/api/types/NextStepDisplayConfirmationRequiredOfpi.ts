 ...
 */
export interface NextStepDisplayConfirmationRequiredOfpi {
    /**
     * The type of `next_step` you need to follow.
     *
     */
    type?: BelvoApi.NextStepDisplayConfirmationRequiredOfpiType;
    openFinanceDisplayConfirmationRequired?: BelvoApi.DisplayConfirmationRequiredOfpi;
    /**
