 ...
 */
export interface NextStepDisplayConfirmationRequiredPse {
    /**
     * The type of `next_step` you need to follow.
     *
     */
    type?: BelvoApi.NextStepDisplayConfirmationRequiredPseType;
    pseDisplayConfirmationRequired?: BelvoApi.DisplayConfirmationRequiredContentPse;
    /**
