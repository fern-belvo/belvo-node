 ...
 */
export interface NextStepDisplayPaymentProcessing {
    /**
     * The type of `next_step` you need to follow.
     *
     */
    type?: BelvoApi.NextStepDisplayPaymentProcessingType;
    openFinanceDisplayPaymentProcessing?: BelvoApi.DisplayPaymentProcessing;
    /**
