...
export interface PaymentIntentOfpi {
    ...
    nextStep: Belvo.PaymentIntentOfpiNextStep;
    lastError: Belvo.LastErrorPaymentError;
    paymentMethodDetails: Belvo.PaymentIntentOfpiPaymentMethodDetails;
    paymentMethodInformation: Belvo.PaymentMethodInformationOfpi;
    /**
