...
export interface PaymentIntentOfpi {
    ...
    nextStep: BelvoApi.PaymentIntentOfpiNextStep;
    lastError: BelvoApi.LastErrorPaymentError;
    paymentMethodDetails: BelvoApi.PaymentIntentOfpiPaymentMethodDetails;
    paymentMethodInformation: BelvoApi.PaymentMethodInformationOfpi;
    /**
