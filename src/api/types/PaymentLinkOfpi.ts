...
export interface PaymentLinkOfpi {
     ...
     */
    accessToken?: string;
    callbackUrls: BelvoApi.PaymentLinkCallbackUrlsResponse;
    paymentIntent?: BelvoApi.PaymentIntentOfpi;
    /**
     * The ISO-8601 timestamp of when the payment link was last updated.
     *
     */
    updatedAt?: string;
    status: BelvoApi.EnumPaymentLinksStatus;
