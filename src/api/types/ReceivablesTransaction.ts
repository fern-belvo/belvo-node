...
export interface ReceivablesTransaction {
    ...
    id: string;
    account: BelvoApi.ReceivablesTransactionAccount;
     ...
     */
    currency: string;
    type?: BelvoApi.EnumReceivableTransactionType;
    /** The total gross amount of the transaction. */
    grossAmount?: number;
    /** The net amount of the transaction. */
    netAmount?: number;
    fees: BelvoApi.RecevablesTransactionFees[];
    status: BelvoApi.EnumReceivableTransactionStatus;
    numberOfInstallments: BelvoApi.ReceivablesTransactionNumberOfInstallments;
}
