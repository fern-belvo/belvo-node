...
export interface RecurringExpenses {
    ...
    transactions: BelvoApi.RecurringExpenseSourceTransaction[];
    frequency: BelvoApi.EnumRecurringExpenseFrequency;
    ...
    category: BelvoApi.EnumRecurringExpenseCategory;
    paymentType: BelvoApi.EnumRecurringExpensePaymentType;
}
