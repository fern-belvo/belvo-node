...
export const InvoiceDetailDian: core.serialization.ObjectSchema<
    serializers.InvoiceDetailDian.Raw,
    BelvoApi.InvoiceDetailDian
...
export declare namespace InvoiceDetailDian {
    interface Raw {
