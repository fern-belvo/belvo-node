...
export const InvoiceWithIdSat: core.serialization.ObjectSchema<
    serializers.InvoiceWithIdSat.Raw,
    BelvoApi.InvoiceWithIdSat
> = core.serialization.object({
    ...
    paymentMethod: core.serialization.property(
        "payment_method",
        core.serialization.lazy(async () => (await import("..")).EnumInvoiceSatPaymentMethod).optional()
    ),
    ...
    invoiceDetails: core.serialization.property(
        "invoice_details",
        core.serialization.list(core.serialization.lazyObject(async () => (await import("..")).InvoiceDetailSat))
    ),
    ...
    senderBlacklistStatus: core.serialization.property(
        "sender_blacklist_status",
        core.serialization.string().optional()
    ),
    receiverBlacklistStatus: core.serialization.property(
        "receiver_blacklist_status",
        core.serialization.string().optional()
    ),
});

export declare namespace InvoiceWithIdSat {
    interface Raw {
        id?: string | null;
        link?: string | null;
        ...
        invoice_details: serializers.InvoiceDetailSat.Raw[];
