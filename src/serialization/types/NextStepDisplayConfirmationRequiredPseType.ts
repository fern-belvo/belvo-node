...
export const NextStepDisplayConfirmationRequiredPseType: core.serialization.Schema<
    serializers.NextStepDisplayConfirmationRequiredPseType.Raw,
    BelvoApi.NextStepDisplayConfirmationRequiredPseType
...
export declare namespace NextStepDisplayConfirmationRequiredPseType {
    type Raw =
        | "pse_display_payment_method_information"
        | "pse_display_credentials_required"
        | "pse_display_needs_redirect"
