...
export const NextStepDisplayCustomerBankAccountsPseType: core.serialization.Schema<
    serializers.NextStepDisplayCustomerBankAccountsPseType.Raw,
    BelvoApi.NextStepDisplayCustomerBankAccountsPseType
...
export declare namespace NextStepDisplayCustomerBankAccountsPseType {
    type Raw =
        | "pse_display_payment_method_information"
        | "pse_display_credentials_required"
        | "pse_display_needs_redirect"
