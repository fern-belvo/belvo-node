...
export const NextStepDisplayNeedsRedirectPseType: core.serialization.Schema<
    serializers.NextStepDisplayNeedsRedirectPseType.Raw,
    BelvoApi.NextStepDisplayNeedsRedirectPseType
...
export declare namespace NextStepDisplayNeedsRedirectPseType {
    type Raw =
        | "pse_display_payment_method_information"
        | "pse_display_credentials_required"
        | "pse_display_needs_redirect"
