...
export const PaymentLinkListPse: core.serialization.ObjectSchema<
    serializers.PaymentLinkListPse.Raw,
    BelvoApi.PaymentLinkListPse
...
export declare namespace PaymentLinkListPse {
    interface Raw {
        id: string;
        created_at: string;
        created_by: string;
